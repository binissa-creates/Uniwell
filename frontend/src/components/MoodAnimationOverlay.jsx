    ...
    return (
      <div className="fixed inset-0 z-[100] pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center animate-scaleIn">
          <div className="bg-white/80 backdrop-blur-md px-8 py-4 rounded-[2rem] shadow-glow border border-[#F6C945]/20 flex items-center gap-4">
  ...
  if (type === 'negative') {
    return (
      <div className="fixed inset-0 z-[100] pointer-events-none overflow-hidden flex items-center justify-center">
        {/* Soft background dim */}
        <div className="absolute inset-0 bg-[#3a2b25]/10 backdrop-blur-[2px] animate-fadeIn" />
        ...
        <div className="relative animate-scaleIn max-w-sm mx-auto px-6">
          <div className="bg-white rounded-[2.5rem] p-8 shadow-lift border border-[#BA1A1A]/5 text-center">
